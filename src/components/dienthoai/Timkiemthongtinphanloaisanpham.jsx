...
function Timkiemdienthoaithongtinphanloai({ id, idloaisanpham, idphanloai }) {
    ...
    const fetchdienthoai = async (filters) => {
        try {
            const data = await ServiceDienthoai.getdanhmuctimkiemdienthoai(filters);
            setData(data)
        } catch (error) {
            console.error("Error fetching token info:", error);
        }
...
export default Timkiemdienthoaithongtinphanloai;
